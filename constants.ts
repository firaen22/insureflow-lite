...
export const TRANSLATIONS = {
  ...
  'zh-CN': {
    ...
    dashboard: {
      ...
      policyDist: '保单分布',
      recentUpdates: '近期保单更新',
      upcomingReminders: '即将到期提醒',
      premiumsDue: '保费到期',
      birthdays: '生日提醒',
      noPremiums: '近期无到期保费。',
      noBirthdays: '近期无客户生日。',
    ...
    upload: {
      title: '新保单处理',
      subtitle: '上传 PDF 文件，利用 AI 自动提取保单详情。',
      dragDropTitle: '拖放保单 PDF',
      dragDropDesc: '支持格式：PDF, JPG, PNG。最大文件：10MB。',
      selectFile: '选择文件',
      uploading: '上传中...',
      analyzing: 'AI 分析中...',
      detecting: '侦测语言 (中文/英文)...',
      identifying: '识别计划名称及附约...',
      matching: '正在比对产品库...',
      complete: '分析完成',
      uploadAnother: '上传另一个',
      privacy: '客户隐私受保护',
      privacyDesc: '云端同步前已启用本地加密。',
      previewTitle: '提取资料预览',
      confidence: '信心指数',
      manualEdit: '手动编辑',
      saveCRM: '保存至 CRM',
      ...
      fields: {
        ...
        expiresSoon: '即将到期',
        newProduct: '新产品',
        newProductDesc: '此计划不在产品库中。保存此保单将记录以供未来自动标记。',
        noTags: '未找到产品库标签。',
        emptyState: '上传文件以在此处查看提取详情。',
        effectiveDate: '生效日期 (YYYY-MM-DD)',
        company: '保险公司'
      }
    },
    clients: {
      ...
      table: {
        ...
        actions: '操作',
        noTags: '无标签',
        notFound: '未找到符合搜索条件的客户。',
        deleteConfirm: '您确定要删除此客户及其所有保单吗？'
      }
    },
    clientDetails: {
      backToClients: '返回客户列表',
      generateReport: '生成报告',
      contactInfo: '联络信息',
      policiesHeld: '持有保单',
      ...
      policyCard: {
        ...
        endDate: '保单结束日期',
        capital: '已投入本金',
        accidentLimit: '意外医疗限额',
        sectionLimit: '各节限额',
        physio: '物理治疗次数/年',
        physioLimit1: '物理治疗限额 1',
        physioLimit2: '物理治疗限额 2',
        bonesetting: '跌打限额',
        acupuncture: '针灸限额'
      }
    },
    ...
    products: {
      ...
      form: {
        ...
        addTag: '新增标签',
        taxDeductible: '可扣税',
        annualLimit: '年度保障限额 (医疗)',
        lifeLimit: '终身保障限额 (医疗)'
      }
    },
    reminders: {
      title: '续保与审查',
      subtitle: '监控即将到周年日的保单，以进行客户审查或更新文件。',
      daysRemaining: '剩余天数',
      policyDetails: '保单详情',
      anniversary: '周年日',
      status: '状态',
      actions: '操作',
      uploadRenewal: '上传续保文件',
      contact: '联络',
      noReminders: '未来 60 天内无即将到期的保单审查。',
      urgent: '紧急',
      upcoming: '即将到来',
      filterAll: '全部',
      filterUrgent: '紧急 (<30 天)'
    },
    report: {
      backToDetails: '返回详情',
      title: '客户报告预览',
    ...
    settings: {
      ...
      baseUrl: 'API 基础网址',
      apiKey: 'API 密钥',
      storedLocally: '密钥储存在浏览器本地缓存中。',
      verifySave: '验证并保存',
      clear: '清除',
      selectModel: '选择 AI 模型',
      keyWorks: '密钥与所选模型可用。',
      keyNotVerified: '密钥已保存但未经验证。请点击“验证并保存”检查可用模型。',
      connection: '数据连接',
      spreadsheetId: 'Google Sheet ID',
      notConnected: '未连接',
      test: '测试连接',
      rulesNotifs: '规则与通知',
      reminderDays: '保单周年日提醒 (天数)',
      reminderDesc: '此天数内将显示客户保单检阅续保的提醒。',
      pdfStudio: 'PDF 报告版面 (工作室)',
      pdfStudioDesc: '自定义在客户 PDF 报告中显示的字段。变更将应用至全域。',
      dataManagement: '数据管理',
