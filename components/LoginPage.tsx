...
export const LoginPage: React.FC = () => {
    return (
        <div className="min-h-screen w-full flex bg-white/[0.02]">
                ...
                <div className="relative z-10 max-w-lg">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-3">
                            <div className="bg-emerald-500/100/20 p-1 rounded-full">
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
                ...
                <div className="w-full max-w-md bg-white/5 backdrop-blur-xl rounded-2xl shadow-xl p-8 lg:p-12 relative z-10 border border-white/5 animate-in fade-in slide-in-from-bottom-8 duration-700">
                    ...
                    <div className="lg:hidden flex items-center gap-2 mb-8 justify-center">
                        ...
                        <span className="text-xl font-bold text-white">InsureFlow Lite</span>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-xs uppercase">
                                <span className="bg-white/5 backdrop-blur-xl px-2 text-slate-400">Secure Access</span>
                            </div>
                        </div>
